...
local set_groups = function()
  local highlights = {
    ...
    -- Oil
    ["OilVcsStatusAdded"] = { fg = c.green, bg = c.none },
    ["OilVcsStatusCopied"] = { fg = c.white, bg = c.none },
    ["OilVcsStatusDeleted"] = { fg = c.cyan, bg = c.none },
    ["OilVcsStatusIgnored"] = { fg = c.black, bg = c.none },
    ["OilVcsStatusModified"] = { fg = c.yellow, bg = c.none },
    ["OilVcsStatusRenamed"] = { fg = c.red, bg = c.none },
    ["OilVcsStatusUntracked"] = { fg = c.blue, bg = c.none },
    ["OilVcsStatusUpstreamAdded"] = { fg = c.green, bg = c.none },
    ["OilVcsStatusUpstreamCopied"] = { fg = c.white, bg = c.none },
    ["OilVcsStatusUpstreamDeleted"] = { fg = c.cyan, bg = c.none },
    ["OilVcsStatusUpstreamIgnored"] = { fg = c.black, bg = c.none },
    ["OilVcsStatusUpstreamModified"] = { fg = c.yellow, bg = c.none },
    ["OilVcsStatusUpstreamRenamed"] = { fg = c.red, bg = c.none },
    ["OilVcsStatusUpstreamUntracked"] = { fg = c.blue, bg = c.none },
  }
